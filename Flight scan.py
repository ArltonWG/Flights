...
kayak = 'https://www.kayak.com/flights/LIS-SIN/2023-07-29-flexible/2023-08-15-flexible?sort=bestflight_a'
driver.get(kayak)
...
#     load_more()
    ...
    matrix = driver.find_element(By.XPATH, '//*[contains(@id,"FlexMatrixCell")]')
...
def page_scrape():
    ...
    dates = driver.find_element(By.XPATH, xp_dates)
    ...
    prices = driver.find_element(By.XPATH, xp_prices)
    prices_list = [price.text.replace('$','') for price in prices if price.text != '']
    prices_list = list(map(int, prices_list))

    # the stops are a big list with one leg on the even index and second leg on odd index
    xp_stops = '//div[@class="section stops"]/div[1]'
    stops = driver.find_element(By.XPATH, xp_stops)
    stops_list = [stop.text[0].replace('n','0') for stop in stops]
    a_stop_list = stops_list[::2]
    b_stop_list = stops_list[1::2]

    xp_stops_cities = '//div[@class="section stops"]/div[2]'
    stops_cities = driver.find_element(By.XPATH, xp_stops_cities)
    ...
    schedules = driver.find_element(By.XPATH, xp_schedule)
    hours_list = []
    carrier_list = []
